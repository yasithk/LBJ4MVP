...
```
  ...
  If you have payed the slightest of attention to this year's playoffs, you know his numbers have been incredible - he leads the league in points, assits, minutes played and add to that he already has seven 40 point games (couple while facing elimination). But I want to compare his production from a slightly different angle. Let's see how much impact James has had on the series relative to everyone else - combined.
